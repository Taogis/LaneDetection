        ...
        with sess.as_default():
            ...
            if net_flag == 'vgg' and weights_path is None:
                pretrained_weights = np.load(
                    '/home/mmtao/test/Codes-for-Lane-Detection/SCNN-Tensorflow/lane-detection-model/data/vgg16.npy',
...
if __name__ == '__main__':
    # init args
    args = init_args()
    args.dataset_dir = '/home/mmtao/test/Codes-for-Lane-Detection/SCNN-Tensorflow/lane-detection-model/'
    #args.weights_path = '/home/mmtao/test/Codes-for-Lane-Detection/SCNN-Tensorflow/lane-detection-model/model_weight/'
    # train lanenet
